...
function downloadMRI(myurl, req, res, callback) {
    ...
    var hash = crypto.createHash('md5').update(myurl).digest('hex'),
        ...
        dest = "../../public/data/" + hash + "/" + filename;
    ...
    request({uri: myurl})
        ...
        .on('close', function () {
            console.log("getBrainAtPath 4: direct download of an mri file");
            atlasMakerServer.getBrainAtPath("/data/" + hash + "/" + filename, function (mri) {
